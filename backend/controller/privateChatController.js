...
cloudinary.config({
    cloud_name: process.env.CLOUDINARY_CLOUD_NAME || "dtntbgpv9",
    api_key: process.env.CLOUDINARY_API_KEY || "626727687999916",
    api_secret: process.env.CLOUDINARY_API_SECRET || "8Gw-vt4BiRkKT1_f8c5kWhLLRMk",
});
